...
def _build_track_strip(
    ...
    if track is None:
        ...
        cv2.putText(canvas, title, (6, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (30, 30, 30), 1, cv2.LINE_AA)
    ...
    cv2.putText(canvas, title, (6, 18), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (20, 20, 20), 1, cv2.LINE_AA)
    ...
    for i, b in enumerate(sampled):
        ...
        if frame is None:
            ...
            crop = _crop_with_padding(frame, b, padding=0.30)
